...
class UserRegisterDTOTest {
    ...
    void shouldThrowExceptionWhenUsernameIsNull() {
        ...
        Assertions.assertThrows(UserRegisterEmptyPropertiesException.class, userRegisterDTO::validate, "Username cannot be empty!");
    }
    ...
    void shouldThrowExceptionWhenEmailDoesNotMatchPattern() {
        ...
        Assertions.assertThrows(UserEmailPatternViolationException.class, userRegisterDTO::validate,
    ...
    void shouldThrowExceptionWhenPasswordIsTooWeak() {
        ...
        Assertions.assertThrows(UserPasswordTooWeakException.class, userRegisterDTO::validate,
    ...
    void shouldThrowExceptionWhenUserWalletBalanceIsLessThanZero() {
        ...
        Assertions.assertThrows(UserWalletBalanceLessThanZeroException.class, userRegisterDTO::validate, "User wallet balance cannot be less than zero!");
    }
