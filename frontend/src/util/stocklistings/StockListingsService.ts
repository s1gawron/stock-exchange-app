...
export default class StockListingsService {
    static getIndexStockListings(index: string | undefined, setStockListings: React.Dispatch<React.SetStateAction<StockListingsDTO>>): void {
        if (index === undefined) {
